...
class CalledTools(authentication_db.Model):
    ...
    agent_run = authentication_db.Column(authentication_db.String(255), nullable=False)
    run_order = authentication_db.Column(authentication_db.Integer, nullable=False)
    tool_call_id = authentication_db.Column(authentication_db.String(255), nullable=False)
